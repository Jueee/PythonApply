...
class CSDNBlogList(scrapy.Spider):
    ...
    def parse(self,response):
        for bloglist in response.xpath("//div[@class='list_item_new']/div[@id='article_list']/div[@class='list_item article_item']"):
            yield{
        ...
        pages = response.xpath("//div[@class='list_item_new']/div[@id='papelist']/a")
        for page in pages:
